...
class IntegrationsViewSet(ViewSet):
  ...
  def create(self, request):
    try:
      ...
      integration = IntegrationsApi.create_integration(name=data['name'], category_id=data['category']['id'])
  ...
  def retrieve(self, request, pk):
    ...
    if not integration: return Response("Integration not found", status=status.HTTP_404_NOT_FOUND)
